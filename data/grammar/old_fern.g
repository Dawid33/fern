...
stat : varList XEQ exprList
     | WHILE expr LPAREN block RPAREN
     | WHILE expr LPAREN RPAREN
     | IF exprThen RPAREN
     | IF exprThen ELSE block
     | IF exprThen ELSE RPAREN
     | IF exprThenElseIfB RPAREN
     | IF exprThenElseIfB ELSE block RPAREN
     | IF exprThenElseIfB ELSE RPAREN
     ;
